...
const transform15 = new Transform({
  position: new Vector3(15, 16, 8.176342964172363),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.883520126342773, 4.795694828033447, 1.0005873441696167)
})
...
const transform16 = new Transform({
  position: new Vector3(15, 16, 4.657499313354492),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.8835272789001465, 4.795694828033447, 1.0005875825881958)
})
...
const transform22 = new Transform({
  ...
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.839683532714844, 4.84365177154541, 1.0007365942001343)
})
...
const transform27 = new Transform({
  position: new Vector3(3.37274169921875, 6.569204330444336, 0.46334952116012573),
  rotation: new Quaternion(-2.464260247952727e-15, 0, 1.088531040241566e-15, 1),
  scale: new Vector3(2.000004291534424, 2.376835823059082, 1.000002145767212)
})
...
const transform29 = new Transform({
  position: new Vector3(15, 6.576384544372559, 10.65749740600586),
  rotation: new Quaternion(-1.9455749640203465e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(2.0000057220458984, 2.380786895751953, 1.0000028610229492)
})
...
const transform32 = new Transform({
  position: new Vector3(0.37274169921875, 11.436811447143555, 2.9643125534057617),
  rotation: new Quaternion(-2.512202736283794e-15, 0.7071068286895752, -8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(2.0000081062316895, 2.266364097595215, 1.0000040531158447)
})
...
imageFromURL15.addComponentOrReplace(transform35)
...
imageFromURL17.addComponentOrReplace(transform36)
...
imageFromURL18.addComponentOrReplace(transform37)
...
imageFromURL19.addComponentOrReplace(transform38)
...
imageFromURL20.addComponentOrReplace(transform39)
...
imageFromURL2.addComponentOrReplace(transform40)
...
const transform43 = new Transform({
  position: new Vector3(7.541407585144043, 6.788402557373047, 0.46334874629974365),
  rotation: new Quaternion(-2.464260247952727e-15, 0, 1.088531040241566e-15, 1),
  scale: new Vector3(2.000004291534424, 2, 1.000002145767212)
})
imageFromURL14.addComponentOrReplace(transform43)
...
script2.spawn(imageFromURL8, {"image":"https://i.ibb.co/KVzx6XZ/52096-A47-C2-DC-4-B57-9318-BCC27-CB777-E0.png"}, createChannel(channelId, imageFromURL8, channelBus))
...
script2.spawn(imageFromURL15, {"image":"https://i.ibb.co/4mJJcrw/edb22b0e174c8c0ebf4e816e5a11116c-dat.png"}, createChannel(channelId, imageFromURL15, channelBus))
...
script2.spawn(imageFromURL14, {"image":"https://i.ibb.co/hDjk8sq/image.png"}, createChannel(channelId, imageFromURL14, channelBus))